...
Future<List<Genre>> getMovieGenres() async {
  return await _getGenres("$apiRoot/genre/movie/list", GenreType.movie);
}

Future<List<Genre>> getTvShowGenres() async {
  return await _getGenres("$apiRoot/genre/tv/list", GenreType.tv);
}

Future<List<Genre>> _getGenres(String url, GenreType genreType) async {
